                ...
                <div class="card card-registration my-4">
                    <div class="row g-0">
                        <div class="col-xl-6 d-none d-xl-block">
                            <img src="https://1.bp.blogspot.com/-1q6JZpTnyK8/XxFm8JX-CFI/AAAAAAAAAPY/rek40UORAgQCL4Er3KJUbasrU-PnB-X_wCLcBGAsYHQ/s1600/tienda%2Bexposici%25C3%25B3n%2B2.jpg" alt="Foto para registro" class="img-fluid" style="border-top-left-radius: .25rem; border-bottom-left-radius: .25rem;" />
                        </div>
                        <div class="col-xl-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input type="text" id="form3Example1m" name="nombre" class="form-control form-control-lg" />
                                                <label class="form-label" for="form3Example1m">Nombre</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                <input type="text" id="form3Example1n" name="apellidos" class="form-control form-control-lg" />
                ...
                <div class="form-outline mb-4">
                  ...
                  <label class="form-label" for="form3Example97">Email ID</label>
                                    ...
                                    <div class="d-flex justify-content-end pt-3">
                                        <input type="reset" value="Limpiar" id="registrar" class="btn btn-light btn-lg">
                                        <input type="submit" value="Registrar" id="registrar" class="btn btn-warning btn-lg ms-2">
                                    </div>
                                </form>
                            </div>
                        </div>
